...
// automatically unset the session if the user lands on this page. This causes the user to resign in if the user hits the back button to "sign out".
      ...
      <div class="loginHeader">
        ...
        <form action="includes/UniversalSignIn.inc.php" method="POST">
          ...
          <div class="form-group">
            ...
            <span class="password"><a href="/HTML_Files/resetpassword/forgot_passwordNew.php">Forgot password?</a></span>&nbsp; &nbsp; &nbsp;

            <span class="username"><a href="/HTML_Files/usernamerecovery/forgot_usernameNew.php">Forgot username?</a></span>
